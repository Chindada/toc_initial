      ...
      <mdb-card-body>
        ...
        <div style="height:10%">
          <b-row>
            ...
            <div>
              <span>{{ $t('all') }} :</span><span style="opacity:0">12</span>
            </div>
            <b-form-checkbox id="checkbox-1" v-model="selectdate" name="checkbox-1">
            </b-form-checkbox>
...
import { mlodIomAPI } from '@/plugins/analyze.js'
