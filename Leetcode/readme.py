...
class Config:
    local_path = '/Users/timhsu/dev_projects/golang/golang_leetcode'
    # solution of leetcode
    github_leetcode_url = 'https://github.com/Chindada/golang_leetcode/blob/master/leetcode-algorithms/'
    # solution of pat,　暫時還沒寫
    github_pat_url = 'https://github.com/Chindada/golang_leetcode/blob/master/pat-algorithms/'
