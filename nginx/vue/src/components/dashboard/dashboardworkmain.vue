<template>
  <div>
    ...
    <class-tab3 v-if="dashboardtype == 3"></class-tab3>
  </div>
</template>
...
import original from '@/components/dashboard/dashboardworkshop'
import cus1 from '@/components/dashboard/dashboardworkshopCustom1'
import factory from '@/components/dashboard/factorydashboard'
