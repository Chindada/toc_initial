  ...
  methods: {
    ...
    efficiency(data) {
      ...
      if (data != null) {
        ...
        if (data.length < secnum) {
          ...
          this.table3 += '</table>'
          this.table3 += this.filllastpage(secnum, secnum - data.length)
        } else {
          //資歷料大於一頁
          data.forEach((item, index) => {
            if (index % secnum == 0 && index != 0) {
    ...
    stablility(data) {
      ...
      if (data != null) {
        ...
        this.table4 += '<tr><td colspan="10">5.' + this.lagnuage.nodata + '</td></tr>'
        this.table4 += '</table>'
    ...
    settable() {
      this.table1 =
        ...
        this.lagnuage.report_manufacture_number +
