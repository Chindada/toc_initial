...
import { mlodWorkhryieldAPI } from '@/plugins/analyze.js'
...
export default {
  ...
  methods: {
    ...
    inichart() {
      ...
      dateAxis.title.text = this.$t('gyr_yaxis') //'模次' //Y軸名稱
      valueAxis.min = 0
      ...
      mlodWorkhryieldAPI({
        ...
        res => {
          if (res.data != null) {
            ...
            // this.chart.data = this.testdata() //res.data
          } else {
            this.chart.data = []
          }
          this.chartshowflag = true
