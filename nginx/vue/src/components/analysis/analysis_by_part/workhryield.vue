...
import { ProduceWorkhryieldAPI } from '@/plugins/analyze.js'
...
export default {
  ...
  methods: {
      ...
      ProduceWorkhryieldAPI({
        ...
        res => {
          ...
          if (res.data != null) {
            ...
            tempdata.push({
              timestamp: this.timeStamptodate(starttime, 'yyyy-mm-dd hh'),
              greenProduction: 0,
              redProduction: 0,
              yellowProduction: 0
            })
            tempdata.push({
              timestamp: this.timeStamptodate(endtime, 'yyyy-mm-dd hh'),
              greenProduction: 0,
              redProduction: 0,
              yellowProduction: 0
            })
    ...
    timeStamptodate(time, type) {
      if (type == 'yyyy-mm-dd hh' || type == 'yyyy-mm-ddThh:00') {
        time = time - 3600000
      }
