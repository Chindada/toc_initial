<template>
  <div style="padding-top: 0.2rem;">
    ...
    <!-- <mdb-btn v-on:click="toschedule()" size="sm" color="danger" :disabled="selected ? selected == 0 : false" href="/basicsetting/machine">轉排程</mdb-btn> -->
    <!-- </div>
...
export default {
  ...
  methods: {
    ...
    classification(alldata) {
      ...
      this.exportbtm = false
      this.taskorfinish = false
      if (alldata != null) {
      ...
      this.setfooternum() //設定頁數this.isbusy = false
      this.isbusy = false
    },
